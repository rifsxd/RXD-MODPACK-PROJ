...
[Files]
Source: "E:\Github\RXD-MODPACK-PROJ\src-steam\World of Tanks Blitz\{#MyAppExeName}"; DestDir: "{app}"; Flags: ignoreversion
Source: "E:\Github\RXD-MODPACK-PROJ\src-steam\MustReadMeBeforeInstalling.txt"; DestDir: "{app}"; Flags: ignoreversion
