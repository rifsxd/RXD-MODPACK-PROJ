...
AppId={{76DF5EEC-FF6E-4D4F-8EEC-72F1C45BF336}
AppName={#MyAppName}
...
UninstallDisplayIcon={app}\RxD.ico
Compression=lzma
...
Source: "C:\Program Files (x86)\The Road To Delphi\VCL Styles Inno\Styles\RubyGraphite.vsf"; DestDir: {app}; Flags: dontcopy
