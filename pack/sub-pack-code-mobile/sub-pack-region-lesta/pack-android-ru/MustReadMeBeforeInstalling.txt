...
To install the modpack first make a backup or change the name of the existing blitz game data folder ( Android/data/com.tanksblitz ) then uninstall the stock blitz apk you installed from playstore or other sources,
 - then install the apk i have provided, after installing the apk is complete, now copy paste back the blitz game data folder "net.wargaming.wot.blitz" back to ( Android/data/ ) or alternatly if just rename the folder then rename the folder to the original name,
  - now you have to copy paste the "com.tanksblitz" provided in the modpack to  ( Android/data/ ) if its ask to overwrite or replace existing files then accept/agree to the promt after all the files are pasted then you are good to go and play the game!
